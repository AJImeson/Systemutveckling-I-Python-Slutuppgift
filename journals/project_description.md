...
A User shall be able to interact with the application in a console/terminal and be able to print the info in real time. The application shall not trigger any alerts while being used/run by a user (This counters what one of the tasks describes).
